...
import Violin from 'components/charts/semiotic-example/violinPlot'
...
<ImageComponent queryString={'postBayd3Pass'} widthProp={300} label='meetup pass @google' displayProp='inline-block' mlProp='50px'/> 
<ImageComponent queryString={'postUberPass'} widthProp={300} label='owl signature pass @Uber ' displayProp='inline-block' mlProp='50px'/> 
